...
# 2020/02/23 - 2021/02/28 (bestseller list is published weekly)
last_year <- seq(as.Date("2020/02/23"), as.Date("2021/02/28"), by = "week") %>%
...
write.csv(top_combined_list, "BestsellerListsCombined.csv")